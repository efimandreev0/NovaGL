...
void glFogi(GLenum pname, GLint param) {
    switch (pname) {
        case GL_FOG_MODE:    if (g.fog_mode != param) { g.fog_mode = param; g.fog_dirty = 1; } break;
        case GL_FOG_START:   if (g.fog_start != param) { g.fog_start = (GLfloat)param; g.fog_dirty = 1; } break;
        case GL_FOG_END:     if (g.fog_end != param) { g.fog_end = (GLfloat)param; g.fog_dirty = 1; } break;
        case GL_FOG_DENSITY: if (g.fog_density != param) { g.fog_density = (GLfloat)param; g.fog_dirty = 1; } break;
        default: break;
    }
}
...
void glFogiv(GLenum pname, const GLint *params) {
    if (pname == GL_FOG_COLOR && params) {
        g.fog_color[0] = params[0] / 2147483647.0f; g.fog_color[1] = params[1] / 2147483647.0f;
        g.fog_color[2] = params[2] / 2147483647.0f; g.fog_color[3] = params[3] / 2147483647.0f;
        g.fog_dirty = 1;
    } else if (params) {
