...
void glColor3b(GLbyte r, GLbyte g_, GLbyte b) {
    g.cur_color[0] = (r + 128) / 255.0f; g.cur_color[1] = (g_ + 128) / 255.0f;
    g.cur_color[2] = (b + 128) / 255.0f; g.cur_color[3] = 1.0f;
}
...
void glColor3d(GLdouble r, GLdouble g_, GLdouble b) {
    g.cur_color[0] = (GLfloat)r; g.cur_color[1] = (GLfloat)g_;
    g.cur_color[2] = (GLfloat)b; g.cur_color[3] = 1.0f;
}
...
void glColor3i(GLint r, GLint g_, GLint b) {
    g.cur_color[0] = r / 2147483647.0f; g.cur_color[1] = g_ / 2147483647.0f;
    g.cur_color[2] = b / 2147483647.0f; g.cur_color[3] = 1.0f;
}
...
void glColor3s(GLshort r, GLshort g_, GLshort b) {
    g.cur_color[0] = r / 32767.0f; g.cur_color[1] = g_ / 32767.0f;
    g.cur_color[2] = b / 32767.0f; g.cur_color[3] = 1.0f;
}
...
void glColor3ui(GLuint r, GLuint g_, GLuint b) {
    g.cur_color[0] = r / 4294967295.0f; g.cur_color[1] = g_ / 4294967295.0f;
    g.cur_color[2] = b / 4294967295.0f; g.cur_color[3] = 1.0f;
}
...
void glColor3us(GLushort r, GLushort g_, GLushort b) {
    g.cur_color[0] = r / 65535.0f; g.cur_color[1] = g_ / 65535.0f;
    g.cur_color[2] = b / 65535.0f; g.cur_color[3] = 1.0f;
}
...
void glColor4b(GLbyte r, GLbyte g_, GLbyte b, GLbyte a) {
    g.cur_color[0] = (r + 128) / 255.0f; g.cur_color[1] = (g_ + 128) / 255.0f;
    g.cur_color[2] = (b + 128) / 255.0f; g.cur_color[3] = (a + 128) / 255.0f;
}
...
void glColor4d(GLdouble r, GLdouble g_, GLdouble b, GLdouble a) {
    g.cur_color[0] = (GLfloat)r; g.cur_color[1] = (GLfloat)g_;
    g.cur_color[2] = (GLfloat)b; g.cur_color[3] = (GLfloat)a;
}
...
void glColor4i(GLint r, GLint g_, GLint b, GLint a) {
    g.cur_color[0] = r / 2147483647.0f; g.cur_color[1] = g_ / 2147483647.0f;
    g.cur_color[2] = b / 2147483647.0f; g.cur_color[3] = a / 2147483647.0f;
}
...
void glColor4s(GLshort r, GLshort g_, GLshort b, GLshort a) {
    g.cur_color[0] = r / 32767.0f; g.cur_color[1] = g_ / 32767.0f;
    g.cur_color[2] = b / 32767.0f; g.cur_color[3] = a / 32767.0f;
}
...
void glColor4ui(GLuint r, GLuint g_, GLuint b, GLuint a) {
    g.cur_color[0] = r / 4294967295.0f; g.cur_color[1] = g_ / 4294967295.0f;
    g.cur_color[2] = b / 4294967295.0f; g.cur_color[3] = a / 4294967295.0f;
}
...
void glColor4us(GLushort r, GLushort g_, GLushort b, GLushort a) {
    g.cur_color[0] = r / 65535.0f; g.cur_color[1] = g_ / 65535.0f;
    g.cur_color[2] = b / 65535.0f; g.cur_color[3] = a / 65535.0f;
}
