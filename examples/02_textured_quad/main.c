...
static unsigned char *generate_checkerboard(int size, int tile_size) {
    ...
    for (int y = 0; y < size; y++)
        for (int x = 0; x < size; x++) {
            ...
            int idx = (y * size + x) * 4;
            pixels[idx + 0] = checker ? 200 : 240;
            pixels[idx + 1] = checker ? 80 : 240;
            pixels[idx + 2] = checker ? 220 : 240;
            pixels[idx + 3] = 255;
        }
    return pixels;
}
...
int main(void) {
    ...
    Vertex quad[6] = {
        {-0.7f, 0.7f, 0.0f, 0.0f, 0.0f, white}, {-0.7f, -0.7f, 0.0f, 0.0f, 2.0f, white},
        {0.7f, -0.7f, 0.0f, 2.0f, 2.0f, white},
        {-0.7f, 0.7f, 0.0f, 0.0f, 0.0f, white}, {0.7f, -0.7f, 0.0f, 2.0f, 2.0f, white},
